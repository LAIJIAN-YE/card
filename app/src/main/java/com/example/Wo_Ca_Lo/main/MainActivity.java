...
import com.example.Wo_Ca_Lo.Login.LoginActivity;
...
import com.example.Wo_Ca_Lo.FragmentViewpage.Dialog_Image;
import com.example.Wo_Ca_Lo.PhraseActivity;
                                ...
                                switch (view.getId()) {
                                    case R.id.dialog_camera:
                                        ...
                                        if(Build.VERSION.SDK_INT>=24){
                                            imageUri= FileProvider.getUriForFile(MainActivity.this,"com.example.Wo_Ca_Lo.fileprovider",outputimage);
                                        }else{
                                            //真實路徑
