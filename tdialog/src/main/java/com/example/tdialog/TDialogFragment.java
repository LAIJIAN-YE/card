 ...
 **/
public class TDialogFragment extends TDialog {
     ...
     */
        ...
        public void TDialogFragment(FragmentManager fragmentManager) {
         ...
         * @return
         */
        public TDialogFragment setLayoutRes(@LayoutRes int layoutRes) {
         ...
         * @return
         */
        public TDialogFragment setDialogView(View view) {
         ...
         * @return
         */
        public TDialogFragment setWidth(int widthPx) {
         ...
         * @return
         */
        public TDialogFragment setHeight(int heightPx) {
         ...
         * 設置彈窗寬度是螢幕寬度的比例 0 -1
         */
        public TDialogFragment setScreenWidthAspect(Context context, float widthAspect) {
         ...
         * 設置彈窗高度是螢幕高度的比例 0 -1
         */
        public TDialogFragment setScreenHeightAspect(Context context, float heightAspect) {
         ...
         * @return
         */
        public TDialogFragment setGravity(int gravity) {
         ...
         * @return
         */
        public TDialogFragment setCancelableOutside(boolean cancel) {
         ...
         * @return
         */
        public TDialogFragment setOnDismissListener(DialogInterface.OnDismissListener dismissListener) {
         ...
         * @return
         */
        public TDialogFragment setDimAmount(float dim) {
            params.mDimAmount = dim;
            return this;
        }

        public TDialogFragment setTag(String tag) {
            params.mTag = tag;
            return this;
        }
         ...
         * @return
         */
        public TDialogFragment setOnBindViewListener(OnBindViewListener listener) {
         ...
         * @return
         */
        public TDialogFragment addOnClickListener(int... ids) {
            params.ids = ids;
            return this;
        }
         ...
         * @return
         */
        public TDialogFragment setOnViewClickListener(OnViewClickListener listener) {
         ...
         * @return
         */
        public TDialogFragment setDialogAnimationRes(int animationRes) {
         ...
         * 監聽彈窗後，返回鍵點擊事件
         */
        public TDialogFragment setOnKeyListener(DialogInterface.OnKeyListener keyListener) {
         ...
         * @return
         */
        public TDialogFragment create() {
            TDialogFragment dialog = new TDialogFragment();
            Log.d(TAG, "create");
...
//            params.apply(dialog.tController);
    ...
    class  FragmentViewAdapter extends FragmentPagerAdapter{
        ArrayList<Fragment> fragments=new ArrayList<>();
        public FragmentViewAdapter(FragmentManager fm) {
            super(fm);
//        fragments.add(PhotoFragment.newInstance(R.drawable.aaa));
//        fragments.add(PhotoFragment.newInstance(R.drawable.bbb));
    }
